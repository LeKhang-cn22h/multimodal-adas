...
- **Chức năng**:
  - Tích hợp bộ lọc ROI giới hạn từ `0.65 * height` trở xuống (tương đương 2/3 chiều cao ảnh theo code tham khảo) để bỏ qua phần vòm cầu và lan can cầu.
  - Kết hợp Canny Edge Detection trực tiếp sau khi giãn nở để đảm bảo mật độ vạch kẻ rõ nét ngay cả khi thiếu sáng.
