...
class Visualizer:
    ...
    def draw_hud(frame, fps, global_risk_level="low"):
        ...
        """
        # Hiển thị FPS
        cv2.putText(frame, f"FPS: {fps:.1f}", (20, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 255, 255), 2, cv2.LINE_AA)
        ...
        cv2.rectangle(frame, (20, 60), (450, 95), (0, 0, 0), -1) # Nền đen cho chữ
        cv2.putText(frame, f"ADAS STATUS: {risk_text}", (30, 85), 
