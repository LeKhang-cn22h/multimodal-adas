"""Result publisher for Seatbelt-Service.

Publishes seatbelt detection results to RabbitMQ.
"""
...
class ResultPublisher:
    """Publishes seatbelt inference results to RabbitMQ."""

    EXCHANGE: str = "adas.exchange"
    EXCHANGE_TYPE: str = "topic"
    ROUTING_KEY: str = "seatbelt.result"
